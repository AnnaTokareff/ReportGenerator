...
Uses template-based generation - fast, free, and predictable.
"""
...
class ReportService:
    ...
    Uses efficient template-based generation - no API calls needed,
    fast execution, and consistent output format.
    """
    ...
    async def generate_markdown(
        ...
        Uses efficient template-based generation - fast, free, and predictable.
        No API calls needed, perfect for MVP and production use.
